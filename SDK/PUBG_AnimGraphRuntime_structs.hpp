...
{
	unsigned char                                      bUseSocket : 1;                                           // 0x0000(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0068(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_ApplyAdditive.AlphaInputType
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	int                                                LODThreshold;                                             // 0x007C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
struct FRBFParams
{
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x000B(0x0001) MISSED OFFSET
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0108(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_PoseDriver.DriveSource
	unsigned char                                      UnknownData02[0x1];                                       // 0x0109(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_PoseDriver.DriveOutput
	...
	unsigned char                                      UnknownData04[0x1];                                       // 0x0139(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_PoseDriver.Type
	unsigned char                                      UnknownData05[0x2];                                       // 0x013A(0x0002) MISSED OFFSET
	float                                              RadialScaling;                                            // 0x013C(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData06[0x38];                                      // 0x0140(0x0038) MISSED OFFSET
};
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
	...
	int                                                LODThreshold;                                             // 0x0140(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsLODEnabled : 1;                                        // 0x0144(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0145(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_RotationOffsetBlendSpace.AlphaInputType
	unsigned char                                      UnknownData01[0x2];                                       // 0x0146(0x0002) MISSED OFFSET
	float                                              ALPHA;                                                    // 0x0148(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FInputScaleBias                             AlphaScaleBias;                                           // 0x014C(0x0008) (CPF_Edit, CPF_BlueprintVisible)
	float                                              ActualAlpha;                                              // 0x0154(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bAlphaBoolEnabled : 1;                                    // 0x0158(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0159(0x0007) MISSED OFFSET
	struct FInputAlphaBoolBlend                        AlphaBoolBlend;                                           // 0x0160(0x0050) (CPF_Edit, CPF_BlueprintVisible)
	struct FName                                       AlphaCurveName;                                           // 0x01B0(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                      // 0x01B8(0x0030) (CPF_Edit, CPF_BlueprintVisible)
};
...
struct FAnimNode_TwoWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData00[0x1];                                       // 0x0060(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_TwoWayBlend.AlphaInputType
	unsigned char                                      UnknownData01[0x3];                                       // 0x0061(0x0003) MISSED OFFSET
	float                                              ALPHA;                                                    // 0x0064(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FInputScaleBias                             AlphaScaleBias;                                           // 0x0068(0x0008) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bAlphaBoolEnabled : 1;                                    // 0x0070(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0071(0x0007) MISSED OFFSET
	struct FInputAlphaBoolBlend                        AlphaBoolBlend;                                           // 0x0078(0x0050) (CPF_Edit, CPF_BlueprintVisible)
	struct FName                                       AlphaCurveName;                                           // 0x00C8(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                      // 0x00D0(0x0030) (CPF_Edit, CPF_BlueprintVisible)
	float                                              InternalBlendAlpha;                                       // 0x0100(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bAIsRelevant : 1;                                         // 0x0104(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bBIsRelevant : 1;                                         // 0x0105(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bResetChildOnActivation : 1;                              // 0x0106(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x00F8(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_AnimDynamics.SimulationSpace
	unsigned char                                      UnknownData01[0x7];                                       // 0x00F9(0x0007) MISSED OFFSET
	struct FBoneReference                              RelativeSpaceBone;                                        // 0x0100(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bChain : 1;                                               // 0x0118(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0119(0x0007) MISSED OFFSET
	struct FBoneReference                              BoundBone;                                                // 0x0120(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              ChainEnd;                                                 // 0x0138(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FVector                                     BoxExtents;                                               // 0x0150(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FVector                                     LocalJointOffset;                                         // 0x015C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	float                                              GravityScale;                                             // 0x0168(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bLinearSpring : 1;                                        // 0x016C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bAngularSpring : 1;                                       // 0x016D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x016E(0x0002) MISSED OFFSET
	float                                              LinearSpringConstant;                                     // 0x0170(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              AngularSpringConstant;                                    // 0x0174(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bEnableWind : 1;                                          // 0x0178(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bWindWasEnabled : 1;                                      // 0x0179(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x2];                                       // 0x017A(0x0002) MISSED OFFSET
	float                                              WindScale;                                                // 0x017C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bOverrideLinearDamping : 1;                               // 0x0180(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0181(0x0003) MISSED OFFSET
	float                                              LinearDampingOverride;                                    // 0x0184(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bOverrideAngularDamping : 1;                              // 0x0188(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0189(0x0003) MISSED OFFSET
	float                                              AngularDampingOverride;                                   // 0x018C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bOverrideAngularBias : 1;                                 // 0x0190(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x0191(0x0003) MISSED OFFSET
	float                                              AngularBiasOverride;                                      // 0x0194(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bDoUpdate : 1;                                            // 0x0198(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bDoEval : 1;                                              // 0x0199(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData08[0x2];                                       // 0x019A(0x0002) MISSED OFFSET
	int                                                NumSolverIterationsPreUpdate;                             // 0x019C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                NumSolverIterationsPostUpdate;                            // 0x01A0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FAnimPhysConstraintSetup                    ConstraintSetup;                                          // 0x01A4(0x005C) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bUsePlanarLimit : 1;                                      // 0x0200(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData09[0x7];                                       // 0x0201(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysPlanarLimit>                PlanarLimits;                                             // 0x0208(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor)
	unsigned char                                      bUseSphericalLimits : 1;                                  // 0x0218(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData10[0x7];                                       // 0x0219(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysSphericalLimit>             SphericalLimits;                                          // 0x0220(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor)
	unsigned char                                      UnknownData11[0x1];                                       // 0x0230(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_AnimDynamics.CollisionType
	unsigned char                                      UnknownData12[0x3];                                       // 0x0231(0x0003) MISSED OFFSET
	float                                              SphereCollisionRadius;                                    // 0x0234(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     ExternalForce;                                            // 0x0238(0x000C) (CPF_Edit, CPF_IsPlainOldData)
	unsigned char                                      UnknownData13[0xC4];                                      // 0x0244(0x00C4) MISSED OFFSET
};
...
{
	struct FBoneReference                              SourceBone;                                               // 0x00F8(0x0018) (CPF_Edit)
	TEnumAsByte<EComponentType>                        SourceComponent;                                          // 0x0110(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0111(0x0007) MISSED OFFSET
	class UCurveFloat*                                 DrivingCurve;                                             // 0x0118(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              Multiplier;                                               // 0x0120(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bUseRange : 1;                                            // 0x0124(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0125(0x0003) MISSED OFFSET
	float                                              RangeMin;                                                 // 0x0128(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RangeMax;                                                 // 0x012C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RemappedMin;                                              // 0x0130(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RemappedMax;                                              // 0x0134(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0138(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_BoneDrivenController.DestinationMode
	unsigned char                                      UnknownData03[0x7];                                       // 0x0139(0x0007) MISSED OFFSET
	struct FName                                       ParameterName;                                            // 0x0140(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FBoneReference                              TargetBone;                                               // 0x0148(0x0018) (CPF_Edit)
	TEnumAsByte<EComponentType>                        TargetComponent;                                          // 0x0160(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0161(0x0003) MISSED OFFSET
	unsigned char                                      bAffectTargetTranslationX : 1;                            // 0x0164(0x0001) (CPF_Edit)
	unsigned char                                      bAffectTargetTranslationY : 1;                            // 0x0164(0x0001) (CPF_Edit)
	unsigned char                                      bAffectTargetTranslationZ : 1;                            // 0x0164(0x0001) (CPF_Edit)
	unsigned char                                      bAffectTargetRotationX : 1;                               // 0x0164(0x0001) (CPF_Edit)
	unsigned char                                      bAffectTargetRotationY : 1;                               // 0x0164(0x0001) (CPF_Edit)
	unsigned char                                      bAffectTargetRotationZ : 1;                               // 0x0164(0x0001) (CPF_Edit)
	unsigned char                                      bAffectTargetScaleX : 1;                                  // 0x0164(0x0001) (CPF_Edit)
	unsigned char                                      bAffectTargetScaleY : 1;                                  // 0x0164(0x0001) (CPF_Edit)
	unsigned char                                      bAffectTargetScaleZ : 1;                                  // 0x0165(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData05[0x2];                                       // 0x0166(0x0002) MISSED OFFSET
	unsigned char                                      UnknownData06[0x1];                                       // 0x0166(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_BoneDrivenController.ModificationMode
};
...
{
	struct FBoneReference                              SourceBone;                                               // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              TargetBone;                                               // 0x0110(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bCopyTranslation : 1;                                     // 0x0128(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bCopyRotation : 1;                                        // 0x0129(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bCopyScale : 1;                                           // 0x012A(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     ControlSpace;                                             // 0x012B(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FAnimNode_CopyBoneDelta : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      bCopyRotation : 1;                                        // 0x0129(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bCopyScale : 1;                                           // 0x012A(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x012B(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_CopyBoneDelta.CopyMode
	float                                              TranslationMultiplier;                                    // 0x012C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RotationMultiplier;                                       // 0x0130(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              ScaleMultiplier;                                          // 0x0134(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
struct FAnimNode_Fabrik : public FAnimNode_SkeletalControlBase
{
	...
	struct FTransform                                  EffectorTransform;                                        // 0x0100(0x0030) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     EffectorTransformSpace;                                   // 0x0130(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0131(0x0007) MISSED OFFSET
	struct FBoneReference                              EffectorTransformBone;                                    // 0x0138(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	TEnumAsByte<EBoneRotationSource>                   EffectorRotationSource;                                   // 0x0150(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0151(0x0007) MISSED OFFSET
	struct FBoneReference                              TipBone;                                                  // 0x0158(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              RootBone;                                                 // 0x0170(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	float                                              Precision;                                                // 0x0188(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                MaxIterations;                                            // 0x018C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bEnableDebugDraw : 1;                                     // 0x0190(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              RightHandFK;                                              // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              LeftHandFK;                                               // 0x0110(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              RightHandIK;                                              // 0x0128(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              LeftHandIK;                                               // 0x0140(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	TArray<struct FBoneReference>                      IKBonesToMove;                                            // 0x0158(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor)
	float                                              HandFKWeight;                                             // 0x0168(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	float                                              ReachPrecision;                                           // 0x00F8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                MaxIterations;                                            // 0x00FC(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<struct FAnimLegIKDefinition>                LegsDefinition;                                           // 0x0100(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	TArray<struct FAnimLegIKData>                      LegsData;                                                 // 0x0110(0x0010) (CPF_ZeroConstructor, CPF_Transient)
};
...
{
	struct FBoneReference                              BoneToModify;                                             // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              LookAtBone;                                               // 0x0110(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FName                                       LookAtSocket;                                             // 0x0128(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     LookAtLocation;                                           // 0x0130(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	TEnumAsByte<EAxisOption>                           LookAtAxis;                                               // 0x013C(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x013D(0x0003) MISSED OFFSET
	struct FVector                                     CustomLookAtAxis;                                         // 0x0140(0x000C) (CPF_Deprecated, CPF_IsPlainOldData)
	struct FAxis                                       LookAt_Axis;                                              // 0x014C(0x0010) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bUseLookUpAxis : 1;                                       // 0x015C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EAxisOption>                           LookUpAxis;                                               // 0x015D(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x015E(0x0002) MISSED OFFSET
	struct FVector                                     CustomLookUpAxis;                                         // 0x0160(0x000C) (CPF_Deprecated, CPF_IsPlainOldData)
	struct FAxis                                       LookUp_Axis;                                              // 0x016C(0x0010) (CPF_Edit, CPF_BlueprintVisible)
	float                                              LookAtClamp;                                              // 0x017C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EInterpolationBlend>                   InterpolationType;                                        // 0x0180(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0181(0x0003) MISSED OFFSET
	float                                              InterpolationTime;                                        // 0x0184(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              InterpolationTriggerThreashold;                           // 0x0188(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              BoneToModify;                                             // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FVector                                     Translation;                                              // 0x0110(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x011C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FVector                                     Scale;                                                    // 0x0128(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 TranslationMode;                                          // 0x0134(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 RotationMode;                                             // 0x0135(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 ScaleMode;                                                // 0x0136(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     TranslationSpace;                                         // 0x0137(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     RotationSpace;                                            // 0x0138(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     ScaleSpace;                                               // 0x0139(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	struct FBoneReference                              BoneToObserve;                                            // 0x00F8(0x0018) (CPF_Edit)
	TEnumAsByte<EBoneControlSpace>                     DisplaySpace;                                             // 0x0110(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRelativeToRefPose : 1;                                   // 0x0111(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0112(0x0002) MISSED OFFSET
	struct FVector                                     Translation;                                              // 0x0114(0x000C) (CPF_IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x0120(0x000C) (CPF_IsPlainOldData)
	struct FVector                                     Scale;                                                    // 0x012C(0x000C) (CPF_IsPlainOldData)
};
...
{
	struct FBoneReference                              TargetBone;                                               // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              SourceBone;                                               // 0x0110(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	float                                              Multiplier;                                               // 0x0128(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneAxis>                             RotationAxisToRefer;                                      // 0x012C(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bIsAdditive : 1;                                          // 0x012D(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
...
{
	struct FBoneReference                              StartBone;                                                // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FBoneReference                              EndBone;                                                  // 0x0110(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0128(0x0001) UNKNOWN PROPERTY: EnumProperty AnimGraphRuntime.AnimNode_SplineIK.BoneAxis
	unsigned char                                      bAutoCalculateSpline : 1;                                 // 0x0129(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x012A(0x0002) MISSED OFFSET
	int                                                PointCount;                                               // 0x012C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<struct FTransform>                          ControlPoints;                                            // 0x0130(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_EditFixedSize, CPF_ZeroConstructor)
	float                                              Roll;                                                     // 0x0140(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              TwistStart;                                               // 0x0144(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              TwistEnd;                                                 // 0x0148(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x014C(0x0004) MISSED OFFSET
	struct FAlphaBlend                                 TwistBlend;                                               // 0x0150(0x0038) (CPF_Edit, CPF_BlueprintVisible)
	float                                              Stretch;                                                  // 0x0188(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              Offset;                                                   // 0x018C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x70];                                      // 0x0190(0x0070) MISSED OFFSET
	struct FSplineCurves                               BoneSpline;                                               // 0x0200(0x0060)
	float                                              OriginalSplineLength;                                     // 0x0260(0x0004) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0264(0x0004) MISSED OFFSET
	TArray<struct FSplineIKCachedBoneData>             CachedBoneReferences;                                     // 0x0268(0x0010) (CPF_ZeroConstructor)
	TArray<float>                                      CachedBoneLengths;                                        // 0x0278(0x0010) (CPF_ZeroConstructor)
	TArray<struct FQuat>                               CachedOffsetRotations;                                    // 0x0288(0x0010) (CPF_ZeroConstructor)
};
...
{
	struct FBoneReference                              SpringBone;                                               // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bLimitDisplacement : 1;                                   // 0x0110(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0111(0x0003) MISSED OFFSET
	float                                              MaxDisplacement;                                          // 0x0114(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              SpringStiffness;                                          // 0x0118(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              SpringDamping;                                            // 0x011C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              ErrorResetThresh;                                         // 0x0120(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bNoZSpring : 1;                                           // 0x0124(0x0001) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      bTranslateX : 1;                                          // 0x0125(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bTranslateY : 1;                                          // 0x0126(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bTranslateZ : 1;                                          // 0x0127(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRotateX : 1;                                             // 0x0128(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRotateY : 1;                                             // 0x0129(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRotateZ : 1;                                             // 0x012A(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
	struct FBoneReference                              TrailBone;                                                // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	int                                                ChainLength;                                              // 0x0110(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EAxis>                                 ChainBoneAxis;                                            // 0x0114(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bInvertChainBoneAxis : 1;                                 // 0x0115(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0116(0x0002) MISSED OFFSET
	float                                              TrailRelaxation;                                          // 0x0118(0x0004) (CPF_ZeroConstructor, CPF_Deprecated, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x011C(0x0004) MISSED OFFSET
	struct FRuntimeFloatCurve                          TrailRelaxationSpeed;                                     // 0x0120(0x0078) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bLimitStretch : 1;                                        // 0x0198(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0199(0x0003) MISSED OFFSET
	float                                              StretchLimit;                                             // 0x019C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FVector                                     FakeVelocity;                                             // 0x01A0(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	unsigned char                                      bActorSpaceFakeVel : 1;                                   // 0x01AC(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x01AD(0x0003) MISSED OFFSET
	struct FBoneReference                              BaseJoint;                                                // 0x01B0(0x0018) (CPF_Edit, CPF_BlueprintVisible)
...
{
	struct FReferenceBoneFrame                         BaseFrame;                                                // 0x00F8(0x0028) (CPF_Edit)
	struct FReferenceBoneFrame                         TwistFrame;                                               // 0x0120(0x0028) (CPF_Edit)
	struct FAxis                                       TwistPlaneNormalAxis;                                     // 0x0148(0x0010) (CPF_Edit)
	float                                              RangeMax;                                                 // 0x0158(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RemappedMin;                                              // 0x015C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              RemappedMax;                                              // 0x0160(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0164(0x0004) MISSED OFFSET
	struct FAnimCurveParam                             Curve;                                                    // 0x0168(0x0010) (CPF_Edit)
...
{
	struct FBoneReference                              IKBone;                                                   // 0x00F8(0x0018) (CPF_Edit, CPF_BlueprintVisible)
	struct FVector                                     EffectorLocation;                                         // 0x0110(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FVector                                     JointTargetLocation;                                      // 0x011C(0x000C) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	struct FName                                       EffectorSpaceBoneName;                                    // 0x0128(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bTakeRotationFromEffectorSpace : 1;                       // 0x0130(0x0001) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bMaintainEffectorRelRot : 1;                              // 0x0130(0x0001) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      bAllowStretching : 1;                                     // 0x0130(0x0001) (CPF_Edit, CPF_BlueprintVisible)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0131(0x0003) MISSED OFFSET
	struct FVector2D                                   StretchLimits;                                            // 0x0134(0x0008) (CPF_Deprecated, CPF_IsPlainOldData)
	float                                              StartStretchRatio;                                        // 0x013C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              MaxStretchScale;                                          // 0x0140(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     EffectorLocationSpace;                                    // 0x0144(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     JointTargetLocationSpace;                                 // 0x0145(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0146(0x0002) MISSED OFFSET
	struct FName                                       JointTargetSpaceBoneName;                                 // 0x0148(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
