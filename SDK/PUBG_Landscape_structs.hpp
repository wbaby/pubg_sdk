...
struct FGrassVariety
{
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0020(0x0001) UNKNOWN PROPERTY: EnumProperty Landscape.GrassVariety.Scaling
	...
	unsigned char                                      bReceivesDecalsEx : 1;                                    // 0x0043(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
