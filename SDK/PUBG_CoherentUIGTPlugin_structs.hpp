...
struct FCoherentUIGTLoadingScreenSettings
{
	...
	unsigned char                                      bAutoCompleteWhenLoadingCompletes : 1;                    // 0x0004(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bWaitForManualStop : 1;                                   // 0x0005(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
