...
public:
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x00B4(0x0001) UNKNOWN PROPERTY: EnumProperty TslItemDragDropOperation.TslItemDragDropOperation_C.MouseOverAttachmentSlotId
	...
	unsigned char                                      UnknownData04[0x1];                                       // 0x00EC(0x0001) UNKNOWN PROPERTY: EnumProperty TslItemDragDropOperation.TslItemDragDropOperation_C.MouseOverSlotId
