...
{
public:
	class UNiagaraComponent*                           NiagaraComponent;                                         // 0x03E8(0x0008) (CPF_Edit, CPF_ExportObject, CPF_ZeroConstructor, CPF_EditConst, CPF_InstancedReference, CPF_IsPlainOldData)
...
public:
	...
	TArray<struct FNiagaraVariable>                    EffectParameterLocalOverrides;                            // 0x0900(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	TArray<struct FNiagaraScriptDataInterfaceInfo>     EffectDataInterfaceLocalOverrides;                        // 0x0910(0x0010) (CPF_Edit, CPF_ZeroConstructor)
	TArray<class UNiagaraDataInterface*>               InstanceDataInterfaces;                                   // 0x0920(0x0010) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient)
	unsigned char                                      bRenderingEnabled : 1;                                    // 0x0930(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0931(0x000F) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData03[0x1];                                       // 0x0040(0x0001) UNKNOWN PROPERTY: EnumProperty Niagara.NiagaraSpriteRendererProperties.SortMode
...
public:
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x00B0(0x0001) UNKNOWN PROPERTY: EnumProperty Niagara.NiagaraScript.NumericOutputTypeSelectionMode
