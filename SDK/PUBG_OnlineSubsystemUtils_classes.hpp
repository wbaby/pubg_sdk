...
// 0x0020 (0x65838 - 0x65818)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x20];                                      // 0x65818(0x0020) MISSED OFFSET
...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0450(0x0001) (CPF_Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0450(0x0001) (CPF_Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0451(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x0454(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0458(0x0018) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x0470(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x0474(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x0478(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x047C(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x03F0(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x03F4(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x03F8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x0410(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x0418(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0420(0x0001) UNKNOWN PROPERTY: EnumProperty OnlineSubsystemUtils.OnlineBeaconClient.ConnectionState
	unsigned char                                      UnknownData01[0x7F];                                      // 0x0421(0x007F) MISSED OFFSET
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x0560(0x0010) (CPF_ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0570(0x0030)
	unsigned char                                      UnknownData01[0x1];                                       // 0x05A0(0x0001) UNKNOWN PROPERTY: EnumProperty OnlineSubsystemUtils.PartyBeaconClient.RequestType
	unsigned char                                      bPendingReservationSent : 1;                              // 0x05A1(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bCancelReservation : 1;                                   // 0x05A2(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x2D];                                      // 0x05A3(0x002D) MISSED OFFSET
...
{
public:
	int                                                ListenPort;                                               // 0x0410(0x0004) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0414(0x0004) MISSED OFFSET
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0418(0x0010) (CPF_ZeroConstructor)
...
{
public:
	struct FString                                     BeaconTypeName;                                           // 0x03E8(0x0010) (CPF_ZeroConstructor, CPF_Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x03F8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x0400(0x0010) (CPF_ZeroConstructor)
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x0410(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x148];                                     // 0x0418(0x0148) MISSED OFFSET
	unsigned char                                      bLogoutOnSessionTimeout : 1;                              // 0x0560(0x0001) (CPF_ZeroConstructor, CPF_Config, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0561(0x0003) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0564(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_Config, CPF_IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0568(0x0004) (CPF_ZeroConstructor, CPF_Transient, CPF_Config, CPF_IsPlainOldData)
