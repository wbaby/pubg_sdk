...
struct UBP_PcSystemMenuWidget_C_OnHiddenWidget_Params
{
};
...
struct UBP_PcSystemMenuWidget_C_DelayedKeyBinding_Params
{
};

// Function BP_PcSystemMenuWidget.BP_PcSystemMenuWidget_C.DoNothing
struct UBP_PcSystemMenuWidget_C_DoNothing_Params
{
};
...
// Function BP_PcSystemMenuWidget.BP_PcSystemMenuWidget_C.Tick
struct UBP_PcSystemMenuWidget_C_Tick_Params
{
...
struct UBP_PcSystemMenuWidget_C_Custom_Event_1_Params
{
};

// Function BP_PcSystemMenuWidget.BP_PcSystemMenuWidget_C.Custom Event_2
struct UBP_PcSystemMenuWidget_C_Custom_Event_2_Params
{
	float*                                             Scale;                                                    // (CPF_Parm, CPF_ZeroConstructor, CPF_IsPlainOldData)
};
