...
public:
	...
	TEnumAsByte<EVerticalAlignment>                    VerticalAlignment;                                        // 0x0049(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x004A(0x0002) MISSED OFFSET
	int                                                ZOrder;                                                   // 0x004C(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             bIsEnabledDelegate;                                       // 0x0040(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0039(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptDelegate                             OnPrepass;                                                // 0x0050(0x000E) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0050(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FText                                       ToolTipText;                                              // 0x0060(0x0018) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	struct FScriptDelegate                             ToolTipTextDelegate;                                      // 0x0078(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData04[0x2];                                       // 0x0078(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	struct FScriptDelegate                             ToolTipWidgetDelegate;                                    // 0x0090(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData05[0x2];                                       // 0x0090(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData06[0x1];                                       // 0x00A0(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.Widget.Visiblity
	unsigned char                                      UnknownData07[0x1];                                       // 0x00A1(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.Widget.Visibility
	unsigned char                                      UnknownData08[0x6];                                       // 0x00A2(0x0006) MISSED OFFSET
	struct FScriptDelegate                             VisibilityDelegate;                                       // 0x00A8(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData09[0x2];                                       // 0x00A2(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      bOverride_Cursor : 1;                                     // 0x00B8(0x0001) (CPF_Edit)
	unsigned char                                      UnknownData10[0x3];                                       // 0x00B9(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData11[0x2];                                       // 0x00BE(0x0002) MISSED OFFSET
	...
	unsigned char                                      UnknownData13[0x28];                                      // 0x00F0(0x0028) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0138(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0138(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0D31(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.ComboBoxString.ConsumeMouseWheel
	unsigned char                                      UnknownData02[0x6];                                       // 0x0D32(0x0006) MISSED OFFSET
	struct FScriptDelegate                             OnGenerateWidgetEvent;                                    // 0x0D38(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0D32(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      UnknownData04[0x40];                                      // 0x0D68(0x0040) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x1];                                       // 0x0138(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.TextLayoutWidget.WrappingPolicy
...
public:
	...
	struct FScriptDelegate                             TextDelegate;                                             // 0x0140(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0140(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FText                                       HintText;                                                 // 0x0150(0x0018) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0168(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0168(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x09E0(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x2];                                       // 0x09E0(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      UnknownData02[0x2];                                       // 0x0A8A(0x0002) MISSED OFFSET
	...
	unsigned char                                      UnknownData03[0x1];                                       // 0x0AA7(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x10];                                      // 0x0AD0(0x0010) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             BrushDelegate;                                            // 0x01C0(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x2];                                       // 0x01C0(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FLinearColor                                ColorAndOpacity;                                          // 0x01D0(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x01E0(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x2];                                       // 0x01E0(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x01F0(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x01F0(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             ContentColorAndOpacityDelegate;                           // 0x0150(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0150(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	struct FScriptDelegate                             BackgroundDelegate;                                       // 0x0208(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0208(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FLinearColor                                BrushColor;                                               // 0x0218(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_IsPlainOldData)
	struct FScriptDelegate                             BrushColorDelegate;                                       // 0x0228(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0228(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      UnknownData04[0x7];                                       // 0x0241(0x0007) MISSED OFFSET
	struct FScriptDelegate                             OnMouseButtonDownEvent;                                   // 0x0248(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData05[0x2];                                       // 0x0241(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptDelegate                             OnMouseButtonUpEvent;                                     // 0x0258(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData06[0x2];                                       // 0x0258(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptDelegate                             OnMouseMoveEvent;                                         // 0x0268(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData07[0x2];                                       // 0x0268(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptDelegate                             OnMouseDoubleClickEvent;                                  // 0x0278(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData08[0x2];                                       // 0x0278(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData09[0x10];                                      // 0x0288(0x0010) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             CheckedStateDelegate;                                     // 0x0148(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0141(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      UnknownData04[0x4];                                       // 0x079C(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData06[0x10];                                      // 0x07E0(0x0010) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnGetMenuContentEvent;                                    // 0x0148(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0148(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	unsigned char                                      RenderOnPhase : 1;                                        // 0x0140(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0141(0x0003) MISSED OFFSET
	int                                                Phase;                                                    // 0x0144(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	int                                                PhaseCount;                                               // 0x0148(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x014C(0x0004) MISSED OFFSET
	class UMaterialInterface*                          EffectMaterial;                                           // 0x0150(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FName                                       TextureParameter;                                         // 0x0158(0x0008) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData02[0x1];                                       // 0x08B3(0x0001) MISSED OFFSET
	...
	unsigned char                                      bUseRightMouseButtonToScroll : 1;                         // 0x08BD(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bGainFocusWhenClickedScrollBar : 1;                       // 0x08BE(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x19];                                      // 0x08BF(0x0019) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             PercentDelegate;                                          // 0x0308(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0306(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	struct FScriptDelegate                             FillColorAndOpacityDelegate;                              // 0x0328(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0328(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             ValueDelegate;                                            // 0x0130(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x2];                                       // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData04[0x14];                                      // 0x054C(0x0014) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownData01[0x7];                                       // 0x0141(0x0007) MISSED OFFSET
	struct FScriptDelegate                             OnGenerateRowEvent;                                       // 0x0148(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0141(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             OnGenerateTileEvent;                                      // 0x0148(0x000E) (CPF_Edit, CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0141(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	struct FScriptDelegate                             HintTextDelegate;                                         // 0x0180(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0180(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0CD0(0x0010) MISSED OFFSET
...
public:
	struct FText                                       Text;                                                     // 0x0150(0x0018) (CPF_Edit)
	struct FScriptDelegate                             TextDelegate;                                             // 0x0168(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0168(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      UnknownData01[0x218];                                     // 0x0200(0x0218) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x01A0(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x2];                                       // 0x01A0(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0230(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0230(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	unsigned char                                      UnknownData03[0x13];                                      // 0x0245(0x0013) MISSED OFFSET
...
{
public:
	unsigned char                                      UnknownData00[0x1];                                       // 0x09F0(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.Space
	unsigned char                                      UnknownData01[0x1];                                       // 0x09F1(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.TimingPolicy
	unsigned char                                      UnknownData02[0x6];                                       // 0x09F2(0x0006) MISSED OFFSET
	class UClass*                                      WidgetClass;                                              // 0x09F8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FIntPoint                                   DrawSize;                                                 // 0x0A00(0x0008) (CPF_Edit, CPF_IsPlainOldData)
	unsigned char                                      bManuallyRedraw : 1;                                      // 0x0A08(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bRedrawRequested : 1;                                     // 0x0A09(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0A0A(0x0002) MISSED OFFSET
	float                                              RedrawTime;                                               // 0x0A0C(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0A10(0x0008) MISSED OFFSET
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x0A18(0x0008) (CPF_IsPlainOldData)
	unsigned char                                      bDrawAtDesiredSize : 1;                                   // 0x0A20(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0A21(0x0003) MISSED OFFSET
	struct FVector2D                                   Pivot;                                                    // 0x0A24(0x0008) (CPF_Edit, CPF_IsPlainOldData)
	unsigned char                                      bReceiveHardwareInput : 1;                                // 0x0A2C(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bWindowFocusable : 1;                                     // 0x0A2D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData06[0x2];                                       // 0x0A2E(0x0002) MISSED OFFSET
	class ULocalPlayer*                                OwnerPlayer;                                              // 0x0A30(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	struct FLinearColor                                BackgroundColor;                                          // 0x0A38(0x0010) (CPF_Edit, CPF_IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x0A48(0x0010) (CPF_Edit, CPF_IsPlainOldData)
	float                                              OpacityFromTexture;                                       // 0x0A58(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData07[0x1];                                       // 0x0A5C(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.BlendMode
	unsigned char                                      bIsTwoSided : 1;                                          // 0x0A5D(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      TickWhenOffscreen : 1;                                    // 0x0A5E(0x0001) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData08[0x1];                                       // 0x0A5F(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x0A60(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_IsPlainOldData)
	unsigned char                                      UnknownData09[0x20];                                      // 0x0A68(0x0020) MISSED OFFSET
	class UBodySetup*                                  BodySetup;                                                // 0x0A88(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial;                                      // 0x0A90(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          TranslucentMaterial_OneSided;                             // 0x0A98(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial;                                           // 0x0AA0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          OpaqueMaterial_OneSided;                                  // 0x0AA8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial;                                           // 0x0AB0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UMaterialInterface*                          MaskedMaterial_OneSided;                                  // 0x0AB8(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x0AC0(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	class UMaterialInstanceDynamic*                    MaterialInstance;                                         // 0x0AC8(0x0008) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	unsigned char                                      bAddedToScreen : 1;                                       // 0x0AD0(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_DuplicateTransient, CPF_IsPlainOldData)
	unsigned char                                      bEditTimeUsable : 1;                                      // 0x0AD1(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData10[0x6];                                       // 0x0AD2(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x0AD8(0x0008) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x0AE0(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_DisableEditOnInstance, CPF_IsPlainOldData)
	unsigned char                                      UnknownData11[0x1];                                       // 0x0AE4(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetComponent.GeometryMode
	unsigned char                                      UnknownData12[0x3];                                       // 0x0AE5(0x0003) MISSED OFFSET
	float                                              CylinderArcAngle;                                         // 0x0AE8(0x0004) (CPF_Edit, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData13[0x34];                                      // 0x0AEC(0x0034) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnHoveredWidgetChanged;                                   // 0x0480(0x0010) (CPF_ZeroConstructor, CPF_InstancedReference, CPF_BlueprintAssignable)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0490(0x0010) MISSED OFFSET
	int                                                VirtualUserIndex;                                         // 0x04A0(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	float                                              PointerIndex;                                             // 0x04A4(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     TraceChannel;                                             // 0x04A8(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x04A9(0x0003) MISSED OFFSET
	float                                              InteractionDistance;                                      // 0x04AC(0x0004) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x04B0(0x0001) UNKNOWN PROPERTY: EnumProperty UMG.WidgetInteractionComponent.InteractionSource
	unsigned char                                      bEnableHitTesting : 1;                                    // 0x04B1(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bShowDebug : 1;                                           // 0x04B2(0x0001) (CPF_Edit, CPF_BlueprintVisible, CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData03[0x1];                                       // 0x04B3(0x0001) MISSED OFFSET
	struct FLinearColor                                DebugColor;                                               // 0x04B4(0x0010) (CPF_Edit, CPF_BlueprintVisible, CPF_IsPlainOldData)
	unsigned char                                      UnknownData04[0x7C];                                      // 0x04C4(0x007C) MISSED OFFSET
	struct FHitResult                                  CustomHitResult;                                          // 0x0540(0x0088) (CPF_Transient, CPF_IsPlainOldData)
	struct FVector2D                                   LocalHitLocation;                                         // 0x05C8(0x0008) (CPF_Transient, CPF_IsPlainOldData)
	struct FVector2D                                   LastLocalHitLocation;                                     // 0x05D0(0x0008) (CPF_Transient, CPF_IsPlainOldData)
	class UWidgetComponent*                            HoveredWidgetComponent;                                   // 0x05D8(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
	struct FHitResult                                  LastHitResult;                                            // 0x05E0(0x0088) (CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bIsHoveredWidgetInteractable : 1;                         // 0x0668(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bIsHoveredWidgetFocusable : 1;                            // 0x0669(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bIsHoveredWidgetHitTestVisible : 1;                       // 0x066A(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
...
public:
	...
	struct FScriptDelegate                             ColorAndOpacityDelegate;                                  // 0x0140(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0140(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FSlateColor                                 ForegroundColor;                                          // 0x0150(0x0028) (CPF_Edit, CPF_BlueprintVisible, CPF_BlueprintReadOnly)
	struct FScriptDelegate                             ForegroundColorDelegate;                                  // 0x0178(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0178(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	...
	class UInputComponent*                             InputComponent;                                           // 0x01F0(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_DuplicateTransient, CPF_IsPlainOldData)
	unsigned char                                      UnknownData07[0x50];                                      // 0x01F8(0x0050) MISSED OFFSET
...
{
public:
	class UWidgetTree*                                 WidgetTree;                                               // 0x03C0(0x0008) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bAllowTemplate : 1;                                       // 0x03C8(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x03C9(0x0007) MISSED OFFSET
	TArray<struct FDelegateRuntimeBinding>             Bindings;                                                 // 0x03D0(0x0010) (CPF_ZeroConstructor)
	TArray<class UWidgetAnimation*>                    Animations;                                               // 0x03E0(0x0010) (CPF_ExportObject, CPF_ZeroConstructor)
	TArray<struct FName>                               NamedSlots;                                               // 0x03F0(0x0010) (CPF_ZeroConstructor)
	unsigned char                                      bValidTemplate : 1;                                       // 0x0400(0x0001) (CPF_ZeroConstructor, CPF_IsPlainOldData)
	unsigned char                                      bTemplateInitialized : 1;                                 // 0x0401(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      bCookedTemplate : 1;                                      // 0x0402(0x0001) (CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData)
	unsigned char                                      UnknownData01[0x5];                                       // 0x0403(0x0005) MISSED OFFSET
	TAssetPtr<class UUserWidget>                       TemplateAsset;                                            // 0x0408(0x0020) (CPF_ExportObject, CPF_InstancedReference)
	class UUserWidget*                                 Template;                                                 // 0x0428(0x0008) (CPF_ExportObject, CPF_ZeroConstructor, CPF_Transient, CPF_InstancedReference, CPF_IsPlainOldData)
