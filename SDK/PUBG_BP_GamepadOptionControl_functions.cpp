...
void UBP_GamepadOptionControl_C::HandleGamepadUpOfChild(const TScriptInterface<class UTslNaviWidgetInterface>& Widget)
{
...
void UBP_GamepadOptionControl_C::HandleGamepadDownOfChild(const TScriptInterface<class UTslNaviWidgetInterface>& Widget)
{
...
void UBP_GamepadOptionControl_C::HandleFocusReceivedOfChild(const TScriptInterface<class UTslNaviWidgetInterface>& Widget)
{
