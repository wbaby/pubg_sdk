...
void AP_Pistol_M1911_BP_C::SetParticleParameter(const struct FName& Name, const struct FVector& Value, bool bEnableRTPC)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.SetParticleParameter");

	AP_Pistol_M1911_BP_C_SetParticleParameter_Params params;
	params.Name = Name;
	params.Value = Value;
...
void AP_Pistol_M1911_BP_C::OnParticleFinish(class UParticleSystemComponent* PSystem)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.OnParticleFinish");

	AP_Pistol_M1911_BP_C_OnParticleFinish_Params params;
...
void AP_Pistol_M1911_BP_C::OnParticleCollide(const struct FName& EventName, float EmitterTime, int ParticleTime, const struct FVector& Location, const struct FVector& Velocity, const struct FVector& Direction, const struct FVector& Normal, const struct FName& BoneName, class UPhysicalMaterial* PhysMat)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.OnParticleCollide");

	AP_Pistol_M1911_BP_C_OnParticleCollide_Params params;
...
void AP_Pistol_M1911_BP_C::OnParameterUpdated()
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.OnParameterUpdated");

	AP_Pistol_M1911_BP_C_OnParameterUpdated_Params params;
...
void AP_Pistol_M1911_BP_C::GetWaterVolumeHeight(bool* OutbIsInWater, float* OutWaterHeight)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.GetWaterVolumeHeight");

	AP_Pistol_M1911_BP_C_GetWaterVolumeHeight_Params params;
...
TEnumAsByte<EPhysicalSurface> AP_Pistol_M1911_BP_C::GetPhysicalSurfaceFromRay(const struct FVector& StartActorOffset, const struct FVector& TraceRay)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.GetPhysicalSurfaceFromRay");

	AP_Pistol_M1911_BP_C_GetPhysicalSurfaceFromRay_Params params;
...
struct FVector AP_Pistol_M1911_BP_C::GetParticleVectorParamter(const struct FName& Name, const struct FVector& DefaultValue)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.GetParticleVectorParamter");

	AP_Pistol_M1911_BP_C_GetParticleVectorParamter_Params params;
	params.Name = Name;
...
float AP_Pistol_M1911_BP_C::GetParticleParamterByName(const struct FName& Name, float DefaultValue)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.GetParticleParamterByName");

	AP_Pistol_M1911_BP_C_GetParticleParamterByName_Params params;
	params.Name = Name;
	params.DefaultValue = DefaultValue;
...
float AP_Pistol_M1911_BP_C::GetParticleParamter(const struct FString& Name, float DefaultValue)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.GetParticleParamter");

	AP_Pistol_M1911_BP_C_GetParticleParamter_Params params;
	params.Name = Name;
	params.DefaultValue = DefaultValue;
...
float AP_Pistol_M1911_BP_C::GetEmitterGlobalSpawnRateScale()
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.GetEmitterGlobalSpawnRateScale");

	AP_Pistol_M1911_BP_C_GetEmitterGlobalSpawnRateScale_Params params;
...
void AP_Pistol_M1911_BP_C::ForceSpawn(int emitterIndex, const struct FVector& InLocation)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.ForceSpawn");

	AP_Pistol_M1911_BP_C_ForceSpawn_Params params;
...
void AP_Pistol_M1911_BP_C::AttachToParent()
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslParticle.AttachToParent");

	AP_Pistol_M1911_BP_C_AttachToParent_Params params;
