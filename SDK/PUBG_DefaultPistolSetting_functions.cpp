...
void ADefaultPistolSetting_C::SimulateUnderwaterTrail(const struct FVector& SurfaceImpactPoint, const struct FVector& ShootDirection, float TravelDistance)
{
...
void ADefaultPistolSetting_C::SimulateUnderwaterHit(const struct FVector& UnderwaterImpactPoint, const struct FVector& ShootOrigin)
{
...
void ADefaultPistolSetting_C::SimulateHit_UnReliable(const struct FHitResult& Impact, const struct FVector& RelLocation)
{
...
void ADefaultPistolSetting_C::SimulateHit_Reliable(const struct FHitResult& Impact, const struct FVector& RelLocation)
{
...
void ADefaultPistolSetting_C::Simulate_CreateAmmoInstance(const struct FVector& ServerStartTrace, const struct FVector& Dir, const struct FAttackId& AttackId)
{
...
void ADefaultPistolSetting_C::ServerWallCheckTest(const struct FVector& TraceStart, const struct FVector& TraceEnd)
{
...
void ADefaultPistolSetting_C::ServerTestBallistics(const struct FVector& Origin, const struct FVector& OriginDir)
{
...
void ADefaultPistolSetting_C::ServerNotifyCrack(class ATslCharacter* TargetCharacter, const struct FVector_NetQuantize& LocationRelative, float BulletVelocity)
{
...
void ADefaultPistolSetting_C::ServerNotifyAmmoSpawned(const struct FVector& ServerStartTrace, const struct FVector& Dir, const struct FAttackId& AttackId)
{
...
void ADefaultPistolSetting_C::ServerLogBodyPenetration(int AttackId, const struct FName& DamageZone, float DamageDiff)
{
...
void ADefaultPistolSetting_C::OnWorldOriginShifted(const struct FVector& InShiftVector)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.TslWeapon_Trajectory.OnWorldOriginShifted");

	ADefaultPistolSetting_C_OnWorldOriginShifted_Params params;
...
void ADefaultPistolSetting_C::ClientWallCheckFail(const struct FVector& TraceStart, const struct FVector& TraceEnd, const struct FVector& Impact)
{
