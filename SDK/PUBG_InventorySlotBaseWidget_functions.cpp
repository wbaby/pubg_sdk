...
// Function InventorySlotBaseWidget.InventorySlotBaseWidget_C.IsSkinInteractionSlot
// (FUNC_Final)
// Parameters:
// bool                           bResult                        (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData)

void UInventorySlotBaseWidget_C::IsSkinInteractionSlot(bool* bResult)
{
	static auto fn = UObject::FindObject<UFunction>("Function InventorySlotBaseWidget.InventorySlotBaseWidget_C.IsSkinInteractionSlot");

	UInventorySlotBaseWidget_C_IsSkinInteractionSlot_Params params;
...
// (FUNC_Final)
// Parameters:
// bool                           bIsApplySkinMode               (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData)
...
// (FUNC_Final)
// Parameters:
// bool                           bIsClearSkinMode               (CPF_Parm, CPF_OutParm, CPF_ZeroConstructor, CPF_IsPlainOldData)
