...
bool UItem_Skin_AK47_Glory_01_C::CheckSkin(const TScriptInterface<class USkinnableInterface>& SkinnableInterface)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.SkinItem.CheckSkin");

	UItem_Skin_AK47_Glory_01_C_CheckSkin_Params params;
...
bool UItem_Skin_AK47_Glory_01_C::ApplySkin(const TScriptInterface<class USkinnableInterface>& SkinnableInterface, int SkinOwnerPlayerId)
{
	static auto fn = UObject::FindObject<UFunction>("Function TslGame.SkinItem.ApplySkin");

	UItem_Skin_AK47_Glory_01_C_ApplySkin_Params params;
	params.SkinnableInterface = SkinnableInterface;
