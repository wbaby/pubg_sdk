...
{
	unsigned char                                      UnknownData00[0x1];                                       // 0x0018(0x0001) UNKNOWN PROPERTY: EnumProperty MovieScene.MovieSceneEvalTemplate.CompletionMode
};
...
struct FMovieSceneAudioSectionTemplateData
{
	...
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0108(0x000E) (CPF_ZeroConstructor, CPF_InstancedReference)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0104(0x0002) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
